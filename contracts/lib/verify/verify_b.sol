...
library SignatureVerifier {
    function verifySignature(bytes32 msghash, bytes memory signature, address signer) public pure returns (bool) {
        address addressFromSig = recoverSigner(msghash, signature);
